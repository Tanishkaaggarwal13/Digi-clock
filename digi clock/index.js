function updateClock() {
  ...
  if (hours >= 5 && hours < 12) {
    ...
    img.style.width = "150px"; // Optional: Set image size
    ...
    // Create an image element
    const img = document.createElement("img");
    img.src = "C:\\Users\\DELL\\OneDrive\\Desktop\\digi clock\\teddy img.png"; // Replace with your actual image path
  ...
  //   bear.textContent = "🐰";
    ...
    greeting.textContent = "Time To Rest GIRLBOSS!";
      ...
      // Create an image element
      const img = document.createElement("img");
      img.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyFPG6zg2GJE7sJibC5qwyh1VHsNAqsBZhnA&s"; // Replace with your actual image path
